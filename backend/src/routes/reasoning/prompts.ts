/**
 * Reasoning Prompts — backend-local mirror.
 *
 * IMPORTANT:
 * - Keep this file in `/backend/src` to satisfy `tsconfig.rootDir`.
 * - Source of truth remains `/shared/contracts/reasoning-prompts.ts`.
 * - Changes must stay byte-for-byte semantically aligned unless versioned.
 */
