 ...
 * Canonical: false
 *
 * Keep behavior equivalent to shared/contracts/reasoning-prompts.ts.
 * Backend tsconfig rootDir excludes shared/, so backend cannot import the
 * canonical shared file directly.
 */
