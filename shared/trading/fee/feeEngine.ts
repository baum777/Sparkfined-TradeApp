import type { FeeTierId } from '../types';
import { FEE_TIERS } from './feeTiers';

export function resolveFeeBps(tier: FeeTierId): number {
  return FEE_TIERS[tier].feeBps;
}

/**
 * Compute fee amount in base units using integer math.
 *
 * IMPORTANT (Phase 1): round DOWN to avoid overcharging.
 */
